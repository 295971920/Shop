							...
							<fieldset>
								<div class="form-group">
									<div class="col-sm-4 control-label">
										<label id="username-lbl" for="username" class="required">账&nbsp;&nbsp;&nbsp;户 ：</label>
									</div>
									<div class="col-sm-8">
										<!-- 账户文本框 -->
								...
								<div class="form-group">
									<div class="col-sm-4 control-label">
										<label id="password-lbl" for="password" class="required">密&nbsp;&nbsp;&nbsp;码 ：</label>
									</div>
									<div class="col-sm-8">
										<!-- 密码文本框 -->
								...
								<div class="form-group">
									...
									<div class="col-sm-8" style="clear: none;">
										...
										<input type="text" name="checkCode" id="checkCode" value=""
											...
											aria-required="true"> 
											<!-- 显示验证码 -->
											<img src="../CheckCode" name="img_checkCode" onclick="myReload()" width="116" height="43" class="img_checkcode" id="img_checkCode" alt="请输入验证码" />
									</div>
								</div>
								<div class="form-group">
